...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-purple-900/30 via-blue-900/30 to-green-900/30 backdrop-blur-lg border-b border-gray-800 py-3 sm:py-4 lg:py-5">
